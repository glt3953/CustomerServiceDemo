...
// 枚举 - 语音识别类型
typedef enum TDDVoiceRecognitionProperty
{
...
//－－－－－－－－－－－－－－－－－－－类方法－－－－－－－－－－－－－－－－－－－－－－－－
// 创建语音识别客户对像，该对像是个单例
+ (DIDIVoiceRecognitionClient *)sharedInstance;
...
/**
 * @brief 设置当前识别模式(deprecated)，请使用-(void)setProperty:(TDDVoiceRecognitionProperty)property;
 *
 * @param 识别模式
 *
 * @return 是否设置成功
...
// 设置识别类型
- (void)setProperty:(TDDVoiceRecognitionProperty)property __attribute__((deprecated));
...
//－－－－－－－－－－－－－－－－－－－产品相关－－－－－－－－－－－－－－－－－－－－－－－
// 如果与DIDI语音技术部有直接合作关系，才需要考虑此方法，否则请使用setApiKey:withSecretKey:方法
- (void)setProductId:(NSString *)aProductId;

// 如果与DIDI语音技术部有直接合作关系，才需要考虑此方法，否则请勿随意设置服务器地址
...
#define BDVR_PARAM_KEY_OTHER_PARAM @"app_paramstr" // 其他参数
...
// 枚举 - 语音识别请求资源类型
typedef enum TDDVoiceRecognitionResourceType
{
...
} TDDVoiceRecognitionResourceType;

- (void)setResourceType:(TDDVoiceRecognitionResourceType)resourceType;
