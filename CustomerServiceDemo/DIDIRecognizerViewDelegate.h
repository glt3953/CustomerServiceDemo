...
@class DIDIRecognizerViewController;

/**
 * @brief - 语音弹窗UI的委托接口
 */
@protocol DIDIRecognizerViewDelegate <NSObject>
 ...
 */
- (void)onEndWithViews:(DIDIRecognizerViewController *)aDIDIRecognizerViewController withResults:(NSArray *)aResults;
 ...
 */
@protocol DIDIRecognizerDialogDelegate <NSObject>
...
@end // DIDIRecognizerDialogDelegate
