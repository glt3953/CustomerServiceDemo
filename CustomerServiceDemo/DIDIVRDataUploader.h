...
#define BDVR_DATA_UPLOADER_ERROR_DOMAIN @"DIDIVRDataUploaderErrorDomain"

@class DIDIVRDataUploader;
...
@protocol DIDIVRDataUploaderDelegate <NSObject>
 ...
 */
-(void)onComplete:(DIDIVRDataUploader *)dataUploader error:(NSError *)error;

@end

@interface DIDIVRDataUploader : NSObject
/**
...
/**
 * @brief 初始化DIDIVRDataUploader示例
 *
 * @param delegate 代理对象
 */
- (instancetype)initDataUploader:(id<DIDIVRDataUploaderDelegate>)delegate;
 ...
 * 请通过实现DIDIVRDataUploaderDelegate监听上传任务状态
 *
 * @param data 联系人数据
 */
