...
@property (nonatomic, copy) NSString *productID;  // 向语音技术部申请
@property (nonatomic, copy) NSString *apiKey;  // 开发者apiKey，在开放平台申请
@property (nonatomic, copy) NSString *secretKey;  // 开发者secretKey，在开放平台申请
