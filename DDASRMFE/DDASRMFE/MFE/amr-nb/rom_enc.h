...
#define M_NB               10    /* Order of LP filter */
#define MP1             (M_NB+1) /* Order of LP filter + 1 */
#define L_WINDOW_NB        240   /* Window size in LP analysis */
...
#define L_TOTAL_NB         320   /* Total size of speech buffer. */
#define L_FRAME_NB         160   /* Frame size */
#define L_FRAME_BY2     80    /* Frame size divided by 2 */
#define L_SUBFR_NB         40    /* Subframe size */
#define L_CODE          40    /* codevector length */
#define PIT_MAX_NB         143   /* Maximum pitch lag */
#define PIT_MIN         20    /* Minimum pitch lag */
#define PIT_MIN_MR122   18    /* Minimum pitch lag (MR122 mode) */
#define L_INTERPOL_NB      (10+1)/* Length of filter for interpolation */
...
#define NC              M_NB/2   /* Order of LP filter divided by 2 */
...
#define COMPLEN_NB 9        /* Number of sub-bands used by VAD              */
...
static const Float32 gamma1[M_NB] =
{
   0.9400024414063F,
   0.8836059570313F,
   0.8305969238281F,
 ...
 */
static const Float32 gamma1_12k2[M_NB] =
{
   0.8999938964844F,
   0.8099975585938F,
   0.72900390625F,
...
static const Float32 gamma2[M_NB] =
{
   0.6000061035156F,
   0.3600158691406F,
   0.2160034179688F,
 ...
 */
static Float32 b60[UP_SAMP_MAX*(L_INTERPOL_NB-1)+1] =
{
   0.898529F,
   0.865051F,
   0.769257F,
 ...
 */
static const Float32 grid_amr[61] =
{
   1.00000F,
   0.998630F,
   0.994522F,
...
static const Float32 lsp_init_data[M_NB] =
   {
      0.9595F,
      0.8413F,
      0.6549F,
